...
class StackTestCase(unittest.TestCase):
    ...
    def testSign(self):
        ...
        # Raw bodied signed
        self.data.update(se=2, de=3, bk=int(raeting.BodyKind.raw), fk=raeting.footKinds.nacl)
        ...
        self.data.update(se=2, de=3, bk=int(raeting.BodyKind.json), fk=raeting.footKinds.nacl)
