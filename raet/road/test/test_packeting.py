...
class BasicTestCase(unittest.TestCase):
    ...
    def testBasicMsgpack(self):
        ...
        hk = int(raeting.HeadKind.json)
        bk = int(raeting.BodyKind.msgpack)
...
class StackTestCase(unittest.TestCase):
    ...
    def testSign(self):
        ...
        # Raw bodied signed
        self.data.update(se=2, de=3, bk=int(raeting.BodyKind.raw), fk=raeting.FootKind.nacl.value)
        ...
        self.data.update(se=2, de=3, bk=int(raeting.BodyKind.json), fk=raeting.FootKind.nacl.value)
